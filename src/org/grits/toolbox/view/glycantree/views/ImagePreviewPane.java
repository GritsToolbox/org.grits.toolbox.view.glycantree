...
public class ImagePreviewPane extends Dialog {
	...
	private void createImagePreviewPane() {
		...
		saveItem.setImage(GlycanVizImages.get(GlycanVizImages.IMG_SAVEEDIT));
		saveItem.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				dialog.setFileName ("glycantree.png");
	...
	public void open (Image image, Point size) {
 		...
 		shell.setImage(GlycanVizImages.get(GlycanVizImages.IMG_REQ_PLUGIN_OBJ));
