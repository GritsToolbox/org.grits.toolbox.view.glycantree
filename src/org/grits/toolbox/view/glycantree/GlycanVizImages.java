...
public class GlycanVizImages {

	private static ImageRegistry PLUGIN_REGISTRY;

	public final static String ICONS_PATH = "icons/"; //$NON-NLS-1$

	private static final String PATH_OBJ = ICONS_PATH; //$NON-NLS-1$
	...
	public static final String IMG_ARROW = "rightarrow.gif"; //$NON-NLS-1$
	...
	public static final ImageDescriptor RIGHT_ARROW = create(PATH_OBJ, IMG_ARROW);
