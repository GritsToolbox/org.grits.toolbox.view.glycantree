...
public class SVGUtils   {  
    ...
    */
     ...
     */
    static public SVGFigureOutput getVectorGraphics(GlycanRendererAWT gr, Collection<Glycan> structures) {
    ...
    /**
       ...
       should be included in the graphical representation
     */
    static public SVGFigureOutput getVectorGraphics(GlycanRendererAWT gr, Collection<Glycan> structures, boolean show_masses, boolean show_redend) {
	    if( structures == null )
	    ...
	    try {
	        ...
	        // commenting this out removes the white rectangle around the image
	     //   g2d.clearRect(0, 0, d.width, d.height); 
	        ...
	        root.setAttributeNS(null, "width", d.width +"");
	        root.setAttributeNS(null, "height", d.height + "");
	      //  root.setAttributeNS(null, "viewBox", "0 0 " + d.height + " " +  d.width);
	      //  root.setAttributeNS(null, "preserveAspectRatio", "xMidYMid meet");
	        
	        // Stream out SVG to a string    
	        StringWriter out = new StringWriter();
	        g2d.stream(root, out, true);
	        
	        return new SVGFigureOutput(out.toString(), d);
	    }
	    catch(Exception e) {
	        LogUtils.report(e);
	        return null;
    ...
    */
    static public void export(OutputStream os, GlycanRendererAWT gr, Collection<Glycan> structures, boolean show_masses, boolean show_redend, double scale, String format,PositionManager posManager,BBoxManager bboxManager) throws Exception {
	    if( format.equals("svg") )
	        os.write(getVectorGraphics(gr,structures,show_masses,show_redend).getSvg().getBytes());
